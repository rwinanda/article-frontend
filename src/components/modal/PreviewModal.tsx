...
const PreviewModal = ({ open, closeModal, data, category }: PreviewModalProps) => {
    ...
    return (
        ...
        >
            <div
                className="bg-white rounded-lg p-6 flex flex-col shadow-xl max-w-2xl w-full max-h-120 overflow-y-scroll"
                onClick={(e) => {
                    e.stopPropagation()
                }}
            >
                ...
                {data.imageUrl && (
                    <div className="flex justify-center items-center rounded-md mb-4">
                        <Image
                            ...
                            width={200}
                            height={200}
                            className="object-cover rounded border-1 border-gray-400"
                        />
                    </div>
                )}
